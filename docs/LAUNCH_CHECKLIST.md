...
- [ ] Run an isolated Bitcoin/LND regtest adapter: standard and hold invoices, exact BOLT 11 decode, delayed/fast blocks, accepted-HTLC cutoff, timeout, LND restart, force close, credential rotation/revocation, and negative macaroon permissions.
  ...
  - [x] Published checkpoint `a3aad9f0fd11b6e5fc6524e7fdf091c36ddf4412` passed all 13 local campaigns and hosted CI; local-only evidence digest `sha256:91289a6613e6d23aa0945852d3cbbdf51396ab5921e22bb74b1334db4d4906d3`.
  - [ ] Complete the remaining prolonged-delay, force-close, unsynced-node, real TLS/credential rotation, and directional-capacity fault matrix. Genuine no-route failure and both exact/same-hash duplicate paths now pass with one LND dispatch.
