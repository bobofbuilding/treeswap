...
- [ ] Run an isolated Bitcoin/LND regtest adapter: standard and hold invoices, exact BOLT 11 decode, delayed/fast blocks, accepted-HTLC cutoff, timeout, LND restart, force close, credential rotation/revocation, and negative macaroon permissions.
  ...
  - [x] Published checkpoint `5a2bb62240e80938256f318f05c48cb20e809825` passed all 18 local campaigns and hosted CI; local-only evidence digest `sha256:605f8794c2d1963fa24bdbb1c16fbfb262673acaa33c835f2777f08a930dc4e6`.
  - [ ] Complete the remaining production-duration delay, real TLS/credential rotation, and directional-capacity fault matrix. Full force-close recovery, genuine unsynced catch-up, no-route failure, compressed-threshold stale-header rejection, and both exact/same-hash duplicate paths now pass with one-or-zero dispatch as required.
