...
**Status:** Exact RPC manifests, expiring credential/TLS isolation, live root-key revocation, signed intent-bound authorization, directional value caps, durable replay journal, coordinator lost-response recovery, and secret-free audits pass isolated regtest; overlap rotation, invoice-side ambiguous-response, and broader failure drills remain deployment gates
