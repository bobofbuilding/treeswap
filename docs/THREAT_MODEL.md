...
**Status:** Canonical/finalized escrow gate, one-shot Lightning revalidation, live rapid-block 24-block cutoff, integrated local two-direction EVM/LND deadline proof, exact EVM claim outbox, two-provider read-only agreement, and local plus pinned live-BIT fork reorg/replacement campaigns implemented; a combined pinned live-BIT-fork timing repeat and public-testnet campaigns through independent providers remain deployment gates
