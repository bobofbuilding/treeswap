...
Operational release inputs no longer enter through opaque operator-supplied support, loss, privacy, or service-isolation hashes. A separate three-role service-isolation verifier requires twelve exact service roles, unique trust domains, exact ingress and encrypted transport, least-privilege credential classes, unique credential sets, bounded rotation windows, and committed network/deployment evidence. Adoption-policy v1 defines exact public limits, directional fees, solver liveness, privacy, loss allocation, support, and upgrade behavior. A separate five-role operational-readiness v3 verifier requires that policy plus exact backup, alert, incident, monitoring, provider, reconciliation, service-isolation, solver, and qualification artifacts; the complete immutable incident-drill set; at least two alert channels; one primary plus two retained observers per drill; bounded timestamps; and five distinct EIP-712 signers across at least two organization commitments. Every signer explicitly signs the adoption-policy digest. Release-candidate v4 binds isolation and adoption evidence plus participant-set digests, requires exact Lightning/security role continuity, keeps the infrastructure signer separate from operational/deployment/review/release authorities, matches alerts, artifacts, liabilities, and drill evidence, and rejects a cap or upstream-policy mismatch. The signatures and commitments still do not prove deployed separation, scoped secrets, drills, alerts, backups, support, retention, or organizational independence; retained external evidence, direct infrastructure inspection, and witnessed drills remain launch gates. See [Adoption policy boundary](./ADOPTION_POLICY.md), [Service isolation evidence](./SERVICE_ISOLATION_EVIDENCE.md), and [Operational readiness evidence](./OPERATIONAL_READINESS_EVIDENCE.md).
