...
| TS-H02 | Dual-signed user exercise plus local atomic admission, capability expiry, capacity, and last-look accounting implemented | Deployed shared enforcement/readers, live reliability telemetry, objective bond decision |
...
| TS-M04 | Signed routing cap, short-lived three-key solver binding, and fresh independently observed directional capacity boundary implemented | Deployed capacity readers/reconciliation and routing telemetry |
