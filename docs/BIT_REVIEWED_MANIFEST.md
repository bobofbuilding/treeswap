...
Clean published source [`a0e8291f6c20816a8ee66387a814f794300efe57`](https://github.com/bobofbuilding/treeswap/commit/a0e8291f6c20816a8ee66387a814f794300efe57) passed 418 application/security tests, both production web build paths, 68 contract tests, all 40 sealed local campaigns, [hosted main-branch CI](https://github.com/bobofbuilding/treeswap/actions/runs/32563882756), and the exact ready [production deployment](https://treeswap-pru2plff2-bittrees-tech.vercel.app), also served through [the canonical alias](https://treeswap.vercel.app). The sealed qualification ran from `2026-08-22T09:05:57.146Z` through `2026-08-22T10:15:06.747Z`. Its ignored mode-`0600` evidence independently reconstructs to `sha256:6274811e83196f98c2bd3543bab930fdc2e325e97bd3a81585ef2456b2fc0da9`; all 132 configuration hashes, 40 unique passed campaigns, three pinned images, canonical clean remote-`main` binding, privacy exclusions, and empty regtest teardown reproduce. The production-duration Lightning campaign enforced the full 3,601-second no-progress minimum, persisted through its midpoint adapter replacement, rejected stale chain state, and dispatched no target payment.
