...
- [ ] Produce a secret-free evidence bundle from the final published release commit containing versions, configuration hashes, test results, and timestamps—never macaroons, invoices, or preimages.
  ...
  - [x] Published checkpoint `4952ea8d463ff8c850c2a40434ed9acf7c47e537` passed all 17 local campaigns and hosted CI; its validated local-only digest is `sha256:ea7129d9201d12ff27cee8cfd1a463f98c6818c1c3944594633bef2446a589ea`.
