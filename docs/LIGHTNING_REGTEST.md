...
Published checkpoint `e6ebaa72f6b746c38e29b350322d880b8a1d9f28` completed all 24 local campaigns from `2026-08-19T21:39:17.714Z` through `2026-08-19T22:45:25.166Z`. Its independently rebuilt evidence digest is `sha256:5f58472ed569fb40ee1abbe9e29c0ee2e1e0c11ee19cf9c7d43bfa6cfcc2bd8b`; the matching [hosted security-and-build run](https://github.com/bobofbuilding/treeswap/actions/runs/32304969494) also passed. This is a reproducible checkpoint, not the final release artifact. The schema-v3 admission tests in this bundle ran on the recorded local Node `v25.5.0`; subsequent recovery checkpoint `dbc9f1daa205549a0af559bc024c40b347ca8ecd` directly passed the same persistence boundary plus recovery drills inside the pinned coordinator Node `22.22.0` image and [hosted CI](https://github.com/bobofbuilding/treeswap/actions/runs/32311057995).
