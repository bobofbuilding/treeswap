...
The deterministic v3 campaign digest is `0x112c28bb8a88dea943d14f4ded189fe4f0b8b1ef568af0ff8ed0b97187719c61`; its exact monitor-policy digest is `0xf63ad20c51dabda8d8c69bc7b0c48dbdba04882c63cb9f4ae769ec537fa26b83`. The harness uses a fixed evidence clock and rejects a preoccupied RPC port so host timing or a stale process cannot change those commitments. The contract suite separately proves an emergency halt blocks new reservations/opens while existing claims, refunds, and solver withdrawals remain callable.
