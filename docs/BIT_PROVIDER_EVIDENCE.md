...
Clean published source [`83f669d6c25b1814554cbdf17b640b704843bcff`](https://github.com/bobofbuilding/treeswap/commit/83f669d6c25b1814554cbdf17b640b704843bcff) passed 422 application/security tests with no skips, both production web builds, 68 contract tests, all 41 sealed local campaigns, and [hosted main-branch CI](https://github.com/bobofbuilding/treeswap/actions/runs/32568051678). The sealed run lasted from `2026-08-22T10:39:12.817Z` through `2026-08-22T11:48:39.941Z`; its ignored mode-`0600` evidence independently reconstructs to `sha256:54b8bfbb76603f0e847a421f97a9c7d5fc7ff3b8972e4cc2334607b2356415cc`. All 133 configuration hashes, 41 unique passed campaigns, three pinned images, clean remote-`main` binding, privacy exclusions, and empty lab teardown reproduce. This local checkpoint verifies the preflight and signed-provider code paths but supplies no real second provider, external review, deployment, or funding authorization.
