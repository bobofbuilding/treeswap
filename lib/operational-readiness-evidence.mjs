...
function normalizePolicy(raw) {
  ...
  if (raw.schema !== "treeswap.operational-readiness-evidence-policy.v2") {
...
function normalizeRecord(raw, policy) {
  ...
  if (raw.schema !== "treeswap.operational-readiness-evidence.v2") {
...
export function prepareOperationalReadinessEvidenceCandidate({
  ...
  return Object.freeze({
    schema: "treeswap.prepared-operational-readiness-evidence.v2",
...
export function verifyOperationalReadinessEvidence({
  ...
  const result = Object.freeze({
    schema: "treeswap.verified-operational-readiness-evidence.v2",
...
export function buildOperationalReadinessReleaseEvidence(verification) {
  ...
  return Object.freeze({
    schema: "treeswap.operational-readiness-release-evidence.v2",
...
export function buildOperationalReadinessEvidenceSummary(verification) {
  ...
  return Object.freeze({
    schema: "treeswap.operational-readiness-evidence-summary.v2",
