...
function normalizePolicy(raw) {
  ...
  if (raw.schema !== "treeswap.operational-readiness-evidence-policy.v1") {
...
function normalizeRecord(raw, policy) {
  ...
  if (raw.schema !== "treeswap.operational-readiness-evidence.v1") {
...
export function prepareOperationalReadinessEvidenceCandidate({ record, policy }) {
  ...
  return Object.freeze({
    schema: "treeswap.prepared-operational-readiness-evidence.v1",
...
export function buildOperationalReadinessAttestationMessage({ record, policy, role, operatorId }) {
  const candidate = prepareOperationalReadinessEvidenceCandidate({ record, policy });
...
export function verifyOperationalReadinessEvidence({
  ...
  const result = Object.freeze({
    schema: "treeswap.verified-operational-readiness-evidence.v1",
  ...
  assertOperationalReadinessEvidenceIsSecretFree(result);
...
export function buildOperationalReadinessReleaseEvidence(verification) {
  ...
  return Object.freeze({
    schema: "treeswap.operational-readiness-release-evidence.v1",
...
export function buildOperationalReadinessEvidenceSummary(verification) {
  ...
  return Object.freeze({
    schema: "treeswap.operational-readiness-evidence-summary.v1",
