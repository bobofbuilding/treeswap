...
export const LIGHTNING_CLOSE_EVIDENCE_SCHEMA = "treeswap.lightning-close-recovery-evidence.v2";
export const LIGHTNING_CLOSE_STATE_SCHEMA = "treeswap.lightning-close-recovery-state.v1";
...
function buildEvidence({ observedAt, blockHeight, policyDigest, summary, reasons }) {
  ...
  const stateDigest = digest({ schema: LIGHTNING_CLOSE_STATE_SCHEMA, ...aggregateState });
