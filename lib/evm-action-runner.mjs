...
function applyEvmClaimObservation(store, observation) {
...
export async function reconcileEvmClaimAction(input) {
  ...
  return applyEvmClaimObservation(input.store, observation);
}
...
export async function reconcileEvmClaimActionWithQuorum({
  ...
  const reconciled = applyEvmClaimObservation(store, observations[0]);
  return Object.freeze({
    ...reconciled,
