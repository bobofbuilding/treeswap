...
export const SAFETY_MONITOR_POLICY_SCHEMA = "treeswap.safety-monitor-policy.v3";
export const SAFETY_OBSERVATION_SCHEMA = "treeswap.safety-observation-attestation.v3";
export const SAFETY_MONITOR_ACTION_PLAN_SCHEMA = "treeswap.safety-monitor-action-plan.v1";
