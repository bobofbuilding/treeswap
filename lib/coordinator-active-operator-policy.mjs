...
function reconciliationProvider(value, index) {
  ...
  if (typeof source.rpcRequestImpl !== "function") {
  ...
  return Object.freeze({
    ...
    rpcRequestImpl: source.rpcRequestImpl,
  });
}
...
export function createCoordinatorLightningActionConfig(input) {
  ...
  if (typeof source.requestImpl !== "function") {
  ...
  const config = Object.freeze({
    ...
    responseKeyId,
    adapterUrl: privateAdapterOrigin(source.adapterUrl),
