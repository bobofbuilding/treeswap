...
export function assessFirmOffer({ offer, solver, policy, now }) {
  ...
  addReason(reasons, solver.admitted !== true, "solver is not admitted");
...
export function reserveFirmOfferCapacity({ solver, assessment }) {
  if (!assessment?.allowed || !assessment.commitment) throw new Error("only an admitted firm offer can reserve capacity");
