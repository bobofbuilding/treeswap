...
const coordinatorReleaseVerificationSupervisors = new WeakSet();

export function isCoordinatorReleaseVerificationSupervisor(value) {
  return Boolean(value && typeof value === "object"
    && coordinatorReleaseVerificationSupervisors.has(value));
}
...
export function createCoordinatorReleaseVerificationSupervisor({
  ...
  const supervisor = Object.freeze({ refresh, status, stop, useActiveActivation });
  coordinatorReleaseVerificationSupervisors.add(supervisor);
  return supervisor;
}
