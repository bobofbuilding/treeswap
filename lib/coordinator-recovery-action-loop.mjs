...
export function createCoordinatorRecoveryActionLoop(input) {
  ...
  const { jobs, lease: jobSetLease } = verifiedJobSet;
  ...
  function releaseJobSetLease() {
    ...
    return releaseRetainedReleaseRecoveryJobSetLease(jobSetLease);
  }
  ...
  function stop() {
    ...
    if (running) void running.then(releaseJobSetLease, releaseJobSetLease);
