  ...
  claimSelection(input) {
    ...
    const row = this.#transaction(() => {
      ...
      const record = this.#database.prepare(`
        SELECT identity_commitment, request_expires_at, request_nonce FROM ${REQUEST_TABLE}
    ...
    SELECTION_CLAIMS.set(selectionClaim, Object.freeze({
...
export function rfqQuoteIngressSelectionBinding(claim) {
  ...
  return Object.freeze({
    identityCommitment: context.identityCommitment,
