...
const CANDIDATE_KINDS = Object.freeze({
  "treeswap.prepared-public-testnet-bootstrap-release-candidate.v2": Object.freeze({
    ...
    status: "deployment-bootstrap-and-independent-review-evidence-verified-awaiting-five-role-release-approvals",
  }),
  "treeswap.prepared-public-testnet-release-candidate.v2": Object.freeze({
    fields: Object.freeze([
      "adoptionSummary",
      "approval",
      "authorizations",
