...
const COORDINATOR_SCHEMA = "treeswap.coordinator.v6";
      ...
      try {
        this.#db.prepare(`
          INSERT INTO firm_offer_commitments(
            ...
            request_id, solver_id, direction, amount, bit_amount_wei, lightning_amount_sats,
        ...
        `).run(
          ...
          value.selectionAuthorizationExpiresAt, value.requestId, value.solverId, value.offer.direction, String(amount),
