...
const COORDINATOR_SCHEMA = "treeswap.coordinator.v7";
...
function normalizeFirmOfferReservation(input) {
  exactKeys(input, [
    ...
    "selectionAuthorizationDigest", "selectionAuthorizationExpiresAt", "solverId",
    ...
    return this.#transaction(() => {
      ...
      try {
        ...
        `).run(
          ...
          value.selectionAuthorizationExpiresAt, value.requestId, value.solverId, value.offer.capabilityDigest,
    ...
    return this.#transaction(() => {
      ...
      if (settlement.executionPolicyBindingDigest) {
        const expected = digest({
          schema: "treeswap.settlement-execution-policy.v1",
