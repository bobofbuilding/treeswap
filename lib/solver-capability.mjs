...
function normalizePolicy(raw) {
  exactKeys(raw, [
    "bitToLightningContract", "chainId", "lightningToBitContract", "maxCapabilityTtlSeconds",
    "maxCapacityObservationAgeSeconds", "maxClockSkewSeconds",
...
export async function verifySolverCapability({
  ...
  if (declaration.availableBitWei === 0n && declaration.availableLightningSats === 0n) {
    reasons.push("solver capability declares no inventory");
  }
