...
export function pinnedPublicSolverContractSigningRequest(urlValue, options, dependencies = {}) {
  return pinnedPublicEndpointRequest(urlValue, options, {
    ...dependencies,
    expectedPath: "/v1/sign-contract-intent",
  });
}

export function pinnedPublicWalletSessionRequest(urlValue, options, dependencies = {}) {
  return pinnedPublicEndpointRequest(urlValue, options, {
    ...dependencies,
    expectedPath: "/api/internal/wallet-session-read",
  });
}
