...
export function assertRfqQuoteIngressReaderOwnershipAvailable(value, deploymentSignal) {
...
export function claimRfqQuoteIngressReaderOwnership(value, deploymentSignal) {
  assertRfqQuoteIngressReaderOwnershipAvailable(value, deploymentSignal);
  const context = READERS.get(value);
