...
} from "./fixtures/verified-deployment-postflight.mjs";
import {
...
async function attestations(candidate = null) {
...
async function verify(candidate = null, attestationSet = null, now = NOW) {
  candidate ??= await fixture();
