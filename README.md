...
- Exact escrow-wallet preflight, one-shot journal-gated EIP-1193 dispatcher, signed non-replayable edge/coordinator claim core, idempotent outcome reporting, durable no-resend restart recovery, transaction/replacement validation, receipt/event classification, and repository-only two-observation agreement in [`docs/CONTRACT_INTENT_WALLET.md`](docs/CONTRACT_INTENT_WALLET.md)
