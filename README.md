...
- Non-dispatching exact escrow-wallet preflight, transaction/replacement validation, receipt/event classification, and repository-only two-observation agreement in [`docs/CONTRACT_INTENT_WALLET.md`](docs/CONTRACT_INTENT_WALLET.md)
...
- Fixed bridge-escrow wallet/RPC dispatchers, durable lifecycle reconciliation, deployed two-provider finality evidence, and explicit approval boundaries; the repository core is documented in [`docs/CONTRACT_INTENT_WALLET.md`](docs/CONTRACT_INTENT_WALLET.md)
